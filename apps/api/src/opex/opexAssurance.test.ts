...
describe("Session 73 compatibility", () => {
  ...
  it("attaches provenance marking the structural zeros in the rollup", async () => {
    ...
    // `explanations` remains a structural zero (playbooks, regulations,
    // governance.gates and collaborationSessionsActive are now measured).
    const structural = provenance.entries.find((e) => e.field === "explanations")!;
