...
export const TI_NAMESPACE_CATALOG: ReadonlyArray<{ prefix: string; scope: TiNamespaceScope }> = [
  ...
  // Sports Intelligence — org-scoped store (`si:<entity>:i:<org>:<id>`).
  // Bare `si` is never added — it would read the entity kind as an org id.
  { prefix: "si:league", scope: "org_scoped" },
  { prefix: "si:team", scope: "org_scoped" },
  { prefix: "si:match", scope: "org_scoped" },
  { prefix: "si:odds", scope: "org_scoped" },
  { prefix: "si:pred", scope: "org_scoped" },
  { prefix: "si:ticket", scope: "org_scoped" },
  { prefix: "si:result", scope: "org_scoped" },
  { prefix: "si:job", scope: "org_scoped" },
  { prefix: "si:cfg", scope: "org_scoped" },
  { prefix: "si:model", scope: "org_scoped" },
  { prefix: "si:backtest", scope: "org_scoped" },
  { prefix: "si:audit", scope: "org_scoped" },
  { prefix: "si:health", scope: "org_scoped" },
  { prefix: "si:alert", scope: "org_scoped" },
  { prefix: "si:dayticket", scope: "org_scoped" },
  // Lottery Intelligence — `li:<entity>:i:<org>:<id>`
  { prefix: "li:cfg", scope: "org_scoped" },
  { prefix: "li:rules", scope: "org_scoped" },
  { prefix: "li:draw", scope: "org_scoped" },
  { prefix: "li:ticket", scope: "org_scoped" },
  { prefix: "li:backtest", scope: "org_scoped" },
  { prefix: "li:job", scope: "org_scoped" },
  { prefix: "li:audit", scope: "org_scoped" },
  { prefix: "li:stat", scope: "org_scoped" },
  { prefix: "li:alert", scope: "org_scoped" },
  // Language Learning — `ll:<entity>:i:<org>:<id>`
  { prefix: "ll:profile", scope: "org_scoped" },
  { prefix: "ll:assessment", scope: "org_scoped" },
  { prefix: "ll:path", scope: "org_scoped" },
  { prefix: "ll:lesson", scope: "org_scoped" },
  { prefix: "ll:vocab", scope: "org_scoped" },
  { prefix: "ll:grammar", scope: "org_scoped" },
  { prefix: "ll:conversation", scope: "org_scoped" },
  { prefix: "ll:writing", scope: "org_scoped" },
  { prefix: "ll:speaking", scope: "org_scoped" },
  { prefix: "ll:listening", scope: "org_scoped" },
  { prefix: "ll:session", scope: "org_scoped" },
  { prefix: "ll:plan", scope: "org_scoped" },
