...
const navItems = [
  ...
  { to: "/app/advanced-leads", icon: Sparkles, label: "Advanced Leads" },
  ...
  { to: "/app/opex-governance", icon: ShieldCheck, label: "Governance & Assurance" },
  ...
  { to: "/app/heart", icon: Heart, label: "Heart Center" },
  { to: "/app/kernel", icon: Network, label: "AI Kernel" },
  { to: "/app/engineering", icon: Gauge, label: "Engineering Ops" },
  { to: "/app/platform-services", icon: Layers, label: "Platform Services" },
  { to: "/app/developer-gateway", icon: Plug, label: "Developer Gateway" },
  ...
  { to: "/platform/providers", icon: PlugZap, label: "Provider Connections" },
  { to: "/platform/cron", icon: CalendarClock, label: "Cron Jobs" },
