...
|---|---|---|---|---|
| 1 | `autonomous` | Autonomous Org (S72) | 6 | 498 |
| 2 | `benchmarks` | Benchmark Center (S50) | 8 | 554 |
| 3 | `cognitive` | Cognitive / World Model (S69) | 27 | 2569 |
| 4 | `knowledge` | knowledge | 20 | 10986 |
| 5 | `memoryEvolution` | Memory Evolution (S47) | 6 | 463 |
| 6 | `mlOps` | ML Ops | 38 | 1733 |
| 7 | `modelFactory` | Model Factory (S46) | 13 | 373 |
| 8 | `nativeAi` | nativeAi | 7 | 1187 |
| 9 | `nativeAiApi` | nativeAiApi | 16 | 1798 |
| 10 | `scientific` | Scientific Research (S68) | 12 | 599 |
| 11 | `training` | Training / LoRA (S60) | 11 | 752 |
| 12 | `v76validation` | S76 Final Validation | 7 | 881 |
