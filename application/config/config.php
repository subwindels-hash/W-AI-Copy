...
/* Suppress deprecation warnings (CI3 on PHP 8.x) without hiding real errors. */
if (function_exists('error_reporting')) { error_reporting(E_ALL & ~E_DEPRECATED & ~E_NOTICE & ~E_WARNING); }
